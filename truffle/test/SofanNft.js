...
contract('SofanNft', accounts => {
    ...
    describe('after a mint', () => {
      // simulate usdc contract
      beforeEach(async function() {
        FiatTokenV2_1Instance = await FiatTokenV2_1.new({from:owner});
        console.log(FiatTokenV2_1Instance);
        FiatTokenProxyInstance = await FiatTokenProxy.new(FiatTokenProxyInstance, {from:owner});
