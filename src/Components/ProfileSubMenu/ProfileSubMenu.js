...
const ProfileSubMenu = ({isProfileSubMenuButtonClicked, setIsProfileSubMenuButtonClicked,  isPageAthlete}) => {
     ...
     const [isOffersReceivedSelected, setIsOffersReceivedSelected] = useState(false)
    ...
    <div className="profileSubMenu-component">
     {isPageAthlete === true && 
     <>
      <div className={isProfileSubMenuButtonClicked[4] ? "profilesubmenu-wrap-clicked profilesubmenu-wrap" : "profilesubmenu-wrap"}>
        <Button onClick={handleProfileSubMenuButtonClicked} text="Feed" style={isProfileSubMenuButtonClicked[4] ? ProfileSubMenuButtonStyle.stylingClicked : ProfileSubMenuButtonStyle.stylingNotClicked}/>
      </div>
      <div className={isProfileSubMenuButtonClicked[5] ? "profilesubmenu-wrap-clicked profilesubmenu-wrap" : "profilesubmenu-wrap"}>
        <Button onClick={handleProfileSubMenuButtonClicked} text="NFT Collections" style={isProfileSubMenuButtonClicked[5] ? ProfileSubMenuButtonStyle.stylingClicked : ProfileSubMenuButtonStyle.stylingNotClicked}/>
      </div>
      <div className={isProfileSubMenuButtonClicked[6] ? "profilesubmenu-wrap-clicked profilesubmenu-wrap" : "profilesubmenu-wrap"}>
        <Button onClick={handleProfileSubMenuButtonClicked} text="Events" style={isProfileSubMenuButtonClicked[6] ? ProfileSubMenuButtonStyle.stylingClicked : ProfileSubMenuButtonStyle.stylingNotClicked}/>
      </div>
      </>
      }
      ...
      {!isOffersReceivedSelected && <div className={isProfileSubMenuButtonClicked[2] ? "profilesubmenu-wrap-clicked profilesubmenu-wrap profilesubmenu-arrow-wrap" : "profilesubmenu-wrap profilesubmenu-arrow-wrap"}>
        ...
        <img onClick={handleProfileOffersSubMenuClicked} src={Arrow} alt="Arrow bottom" />
      </div>}
      {isOffersReceivedSelected && <div className={isProfileSubMenuButtonClicked[3] ? "profilesubmenu-wrap-clicked profilesubmenu-wrap profilesubmenu-arrow-wrap" : "profilesubmenu-wrap profilesubmenu-arrow-wrap"}>
