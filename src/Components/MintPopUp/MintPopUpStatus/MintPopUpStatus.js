...
function MintPopUpStatus({ statusMint }) {
  return (
    <>
      {/* {statusMint} */}
      <div className="mint-pop-up-status-container">
        ...
        {statusMint ? (
          <>
            <button className="mint-pop-up-status-button">Go to my profile</button>
          </>
        ) : (
          <>
            <button className="mint-pop-up-status-button">Back to launchpad</button>
          </>
        )}
      </div>
    </>
