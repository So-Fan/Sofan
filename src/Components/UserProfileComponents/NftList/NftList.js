...
function NftList({
  ...
  return (
    ...
    <div className="user-nft-transfer-container">
      <div className={`nft-origin-type ${formulatedOffersDisplaySourceType}`}>Mint</div>
      <div className={`user-nft-picture-and-title ${formulatedOffersNftContentClass}`}>
      ...
      <div className={`nft-price-user-activity ${formulatedOffersYourOffersPriceClass}`}>
        <div className="nftc-price-eth-user-activity">0.50 ETH</div>
        <div className="nft-price-eur-user-activity">692.04€</div>
      </div>
      <div className={`nft-quantity-user-activity ${formulatedOffersFromClass}`}>
        {activityUserQuantity}
        {formulatedOffersFrom}
      </div>
      ...
      <div className={`nft-date-transfer-user-activity ${formulatedOffersDateClass}`}>1 hours ago</div>
    </div>
  );
}
