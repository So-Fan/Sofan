...
function LandingPage() {
  return (
    <>
      ...
      <section className="error-mobile-waiting-page">
        ...
        <div className="socials-network-waiting-page">
          ...
          <div className="logo-socials-waiting-page">
            ...
            <a target={"_blank"} href="https://instagram.com/sofan_app/">
              <svg className="svg-socials-waiting-page" viewBox="0 0 448 512">
            ...
            <a target={"_blank"} href="https://github.com/So-Fan/Sofan">
      ...
      {/* Dekstop display */}
      <section className="waiting-page-container">
        <div className="logo-sofan-waiting-page-container">
          <img src={sofanLogo} alt="" />
        </div>
        <div className="explore-picture-and-text-waiting-page">
          SORT BIENTÔT...
          <img
            className="explore-picture-waiting-page"
            src={explorePicture}
            alt=""
          />
        </div>
