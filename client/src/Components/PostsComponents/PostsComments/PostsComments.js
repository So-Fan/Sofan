...
function PostsComments({
  ...
  isPostClicked,
  likeButtonSize,
  isDropDownMenuCommentClicked, setIsDropDownMenuCommentClicked, comments
}) {
  ...
  function handleDropDownMenuClick() {
    console.log(isDropDownMenuCommentClicked);
    setIsDropDownMenuCommentClicked(!isDropDownMenuCommentClicked);
  }
  ...
  //           {/* Comment this code below when Like button is about to be functionnal with backend */}
    ...
    <>
      <div className="posts-comments-component-container">
        ...
        <div className="posts-comments-component-comments-like-button-and-dropdown">
          ...
          >
            <img src={dropDownImage} alt="MENU DEROULANT COMMENTAIRE" />
            {isDropDownMenuCommentClicked && (
              <>
                <DropDownMenu
                  isDropDownMenuCommentClicked={isDropDownMenuCommentClicked}
                />
              </>
            )}
          </div>
